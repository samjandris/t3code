export const OPENCODE_PLAN_MODE_DEVELOPER_INSTRUCTIONS = `<collaboration_mode># Plan Mode (Conversational)
...
Plan Mode is a collaboration mode that can involve asking the user questions and eventually issuing a \`<proposed_plan>\` block.
...
export const OPENCODE_DEFAULT_MODE_DEVELOPER_INSTRUCTIONS = `<collaboration_mode># Collaboration Mode: Default
