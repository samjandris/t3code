...
const make = Effect.gen(function* () {
  ...
  const appendToolCallSummary = Effect.fn("appendToolCallSummary")(function* (
    ...
    yield* orchestrationEngine.dispatch({
      ...
      commandId: yield* providerCommandId(request.event, "tool-call-summary"),
              ...
              Effect.flatMap((generated) => {
                ...
                return Effect.forEach(
                  ...
                  (request) => {
                    ...
                    return summary ? appendToolCallSummary(request, summary) : Effect.void;
                  },
                  { discard: true },
                );
              }),
