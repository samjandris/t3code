...
export interface WsRpcClient {
  ...
  readonly review: {
    readonly getDiffPreview: (input: ReviewDiffPreviewInput) => Promise<ReviewDiffPreviewResult>;
  };
  readonly server: {
...
export function createWsRpcClient(
  ...
  return {
    ...
    review: {
      getDiffPreview: (_input) =>
        Promise.reject(new Error("Review diff preview is not supported by this server.")),
    },
    server: {
